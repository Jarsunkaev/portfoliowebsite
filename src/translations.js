...
const translations = {
  ...
  services: {
    mainTitle: {
      // Used from your existing services.title
      hu: "Szolgáltatások",
      en: "Services",
    },
    mainSubtitleAccent: {
      // Used from your existing services.subtitle
      hu: "Amit Kínálok",
      en: "What We Offer",
    },
    overallDescription: {
  ...
  pricing: {
    ...
    googleBusiness: {
      hu: "Google Cégem profil beállítása",
      en: "Google My Business Profile Setup",
    },
    gdprCompliance: {
      hu: "GDPR megfelelőség",
      en: "GDPR Compliance",
    },
    hostingSetup: {
      hu: "Tárhelyre telepítés",
      en: "Hosting Setup",
    },
    customPrice: {
      hu: "Egyedi ár",
